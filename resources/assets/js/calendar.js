...
(function (root, factory) {
  ...
  function Calendar(settings) {
    ...
    this.format.input =       settings.format && settings.format.input || 'MMM D, YYYY';
    ...
    this.text_init = settings.text_init ? settings.text_init : null;
    ...
    this.callbackAlways = settings.callbackAlways || false;
    ...
    $('.dr-message').click(function(event) {
    	$('.dr-dates-init').removeClass('dr-dates-init');
    	$('.dr-date').first().trigger('click');
    });
  ...
  Calendar.prototype.presetCreate = function() {
    ...
    $.each(presets, function(i, d) {
      ...
      var string = moment(d.start).format(self.format.preset) +' <i class="mdi mdi-arrow-right-thick"></i> '+ moment(d.end).format(self.format.preset);
  ...
  Calendar.prototype.calendarHTML = function(type) {
	...
	var input_start_date = moment(this.start_date).format(this.format.input);
	var input_end_date = moment(this.end_date).format(this.format.input);
    ...
    if (type == "double")
      return this.element.append('<div class="dr-input">' +
        '<div class="dr-dates '+(this.text_init ? ' dr-dates-init' : '')+'">' +
          '<a href="#" class="dr-reset"><i class="mdi mdi-reload"></i></a>' +
          '<div class="dr-date dr-date-start" contenteditable>'+ input_start_date +'</div>' +
          '<span class="dr-dates-dash"><i class="mdi mdi-arrow-right-thick"></i></span>' +
          '<div class="dr-date dr-date-end" contenteditable>'+ input_end_date +'</div>' +
          '<div class="dr-message"><i class="mdi mdi-filter"></i>&nbsp;&nbsp;'+ this.text_init +'</div>' +
        '</div>' +
