...
(function (root, factory) {
    ...
    function _create() {
        ...
        uploadInput.setAttribute('class', 'form-control inputfile');
        uploadInput.setAttribute('accept', 'image/x-png,image/jpeg');

        labelInput = document.createElement('label');
        labelInput.innerHTML = '<i class="mdi mdi-upload"></i> '+self.options.uploadText;

        uploadWrap.setAttribute('class', 'cr-upload-wrap');
        ...
        uploadInput.addEventListener("change", function(){
        	if(self.options.onInputChange && typeof self.options.onInputChange === 'function')
        		self.options.onInputChange(uploadInput);
        })
        ...
        self.element.appendChild(uploadWrap);
        uploadWrap.appendChild(uploadInput);
        uploadWrap.appendChild(labelInput);
